...
var UnstyledButton_module = require('./UnstyledButton.module.css.js');
...
const UnstyledButton = polymorphicFactory.polymorphicFactory(
  (_props, ref) => {
    ...
    const getStyles = useStyles.useStyles({
      ...
      props,
      classes: UnstyledButton_module['default'],
      className,
      style,
      classNames,
      styles,
...
UnstyledButton.classes = UnstyledButton_module['default'];
