...
.m-b5489c3c {
  ...
  padding-right: var(--_pr, calc(var(--mb-padding, var(--mantine-spacing-md)) - calc(0.3125rem * var(--mantine-scale))));
...
[dir="rtl"] .m-b5489c3c {
    ...
    --_pl: calc(var(--mb-padding, var(--mantine-spacing-md)) - calc(0.3125rem * var(--mantine-scale)));
}
...
.m-6c018570 {
  ...
  --_input-line-height: calc(var(--_input-height) - calc(0.125rem * var(--mantine-scale)));
  ...
  --_input-left-section-size: var(
    ...
    calc(var(--_input-height) - calc(0.125rem * var(--mantine-scale)))
  );
...
.m-8fb7ebe7[data-monospace] {
    ...
    --_input-fz: calc(var(--input-fz, var(--mantine-font-size-sm)) - calc(0.125rem * var(--mantine-scale)));
  }
...
.m-66836ed3 {
  ...
  border: var(--alert-bd, calc(0.0625rem * var(--mantine-scale)) solid transparent);
...
.m-88b62a41 {
  --_combobox-padding: var(--combobox-padding, calc(0.25rem * var(--mantine-scale)));
...
.m-104cd71f {
  ...
  border: var(--avatar-bd, calc(0.0625rem * var(--mantine-scale)) solid transparent);
...
.m-347db0ec {
  ...
  border: var(--badge-bd, calc(0.0625rem * var(--mantine-scale)) solid transparent);
}
...
.m-77c9d27d {
  ...
  border: var(--_button-bd, var(--button-bd, calc(0.0625rem * var(--mantine-scale)) solid transparent));
...
@media (hover: none) {
    [data-mantine-color-scheme='light'] .m-3904c1af:not([data-disabled]):active {
      --_chip-bg: var(--mantine-color-gray-0);
  }
...
[data-mantine-color-scheme='light'] .m-3904c1af:not([data-disabled]) {
    ...
    --_chip-bd: calc(0.0625rem * var(--mantine-scale)) solid var(--mantine-color-gray-3);
}

[data-mantine-color-scheme='dark'] .m-3904c1af:not([data-disabled]) {
    --_chip-bg: var(--mantine-color-dark-6);
    --_chip-bd: calc(0.0625rem * var(--mantine-scale)) solid var(--mantine-color-dark-4);
}
...
@media (hover: hover) {
  ...
  [data-mantine-color-scheme] .m-3904c1af:not([data-disabled])[data-checked]:hover {
...
@media (hover: none) {
  ...
  [data-mantine-color-scheme] .m-3904c1af:not([data-disabled])[data-checked]:active {
      --_chip-bg: var(--chip-hover);
  }
}
...
@media (hover: hover) {
    [data-mantine-color-scheme='light'] .m-fa109255:not([data-disabled]):hover, [data-mantine-color-scheme='light'] .m-f7e165c3:not([data-disabled]):hover {
      --_chip-bg: var(--mantine-color-gray-1);
  }

    [data-mantine-color-scheme='dark'] .m-fa109255:not([data-disabled]):hover, [data-mantine-color-scheme='dark'] .m-f7e165c3:not([data-disabled]):hover {
      --_chip-bg: var(--mantine-color-dark-5);
  }
}

@media (hover: none) {
    [data-mantine-color-scheme='light'] .m-fa109255:not([data-disabled]):active, [data-mantine-color-scheme='light'] .m-f7e165c3:not([data-disabled]):active {
      --_chip-bg: var(--mantine-color-gray-1);
  }

    [data-mantine-color-scheme='dark'] .m-fa109255:not([data-disabled]):active, [data-mantine-color-scheme='dark'] .m-f7e165c3:not([data-disabled]):active {
      --_chip-bg: var(--mantine-color-dark-5);
  }
}

[data-mantine-color-scheme='light'] .m-fa109255:not([data-disabled]), [data-mantine-color-scheme='light'] .m-f7e165c3:not([data-disabled]) {
    --_chip-bg: var(--mantine-color-gray-0);
}

[data-mantine-color-scheme='dark'] .m-fa109255:not([data-disabled]), [data-mantine-color-scheme='dark'] .m-f7e165c3:not([data-disabled]) {
    --_chip-bg: var(--mantine-color-dark-6);
}

[data-mantine-color-scheme] .m-fa109255:not([data-disabled])[data-checked], [data-mantine-color-scheme] .m-f7e165c3:not([data-disabled])[data-checked] {
    --_chip-icon-color: var(--chip-color);
...
@media (hover: hover) {
  ...
  [data-mantine-color-scheme] .m-fa109255:not([data-disabled])[data-checked]:hover, [data-mantine-color-scheme] .m-f7e165c3:not([data-disabled])[data-checked]:hover {
      --_chip-bg: var(--chip-hover);
  }
}
...
@media (hover: none) {
  ...
  [data-mantine-color-scheme] .m-fa109255:not([data-disabled])[data-checked]:active, [data-mantine-color-scheme] .m-f7e165c3:not([data-disabled])[data-checked]:active {
      --_chip-bg: var(--chip-hover);
  }
}
...
.m-d8ee6fd8 {
  ...
  min-width: 0;
  min-height: 0;
  flex: 1 0 calc(var(--cp-swatch-size) - calc(0.25rem * var(--mantine-scale)));
}
...
.m-efdf90cb {
  ...
  border-top: calc(0.0625rem * var(--mantine-scale)) solid var(--_divider-color);
}
...
.m-e17b862f {
  padding-left: var(--_children-pl, var(--nl-offset, var(--mantine-spacing-lg)));
...
.m-a513464 {
  ...
  display: flex;
  align-items: center;
  padding-left: var(--_root-padding-left, calc(1.375rem * var(--mantine-scale)));
...
.m-95e17d22 {
  ...
  flex-direction: column;
  width: 100%;
  height: calc(var(--_input-height) - calc(0.125rem * var(--mantine-scale)));
...
.m-80b4b171 {
  ...
  --_control-radius: calc(var(--_input-radius) - calc(0.0625rem * var(--mantine-scale)));

  flex: 0 0 50%;
  width: 100%;
  padding: 0;
  height: calc(var(--_input-height) / 2 - calc(0.0625rem * var(--mantine-scale)));
...
.m-80b4b171:first-of-type {
    border-bottom: calc(0.03125rem * var(--mantine-scale)) solid var(--_input-bd);
...
.m-f3ed6b2b {
  ...
  transform: var(--_radio-icon-transform, scale(0.2) translateY(calc(0.625rem * var(--mantine-scale))));
  transition:
    opacity 100ms ease,
...
.m-2a371ac9 {
  --_separator-offset: calc(var(--stepper-icon-size) / 2 - calc(0.0625rem * var(--mantine-scale)));
...
.m-2a371ac9[data-orientation='vertical'] {
    ...
    --_separator-mb: calc(var(--mantine-spacing-xs) - calc(0.125rem * var(--mantine-scale)));
  }
...
[dir="rtl"] .m-2a371ac9[data-orientation='vertical'][data-icon-position='left'] {
        --_separator-ml: 0;
...
[dir="rtl"] .m-2a371ac9[data-orientation='vertical'][data-icon-position='right'] {
        --_separator-ml: var(--_separator-offset);
        --_separator-mr: 0;
}
...
.m-6496b3f3 {
  ...
  height: 100vh;
  position: absolute;
  border-left: calc(0.125rem * var(--mantine-scale)) solid var(--_separator-border-color);
}
...
.m-1959ad01 {
  ...
  border: calc(0.125rem * var(--mantine-scale)) solid var(--_step-icon-border-color);
